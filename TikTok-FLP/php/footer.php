	<footer>
		...
		<div id="terms-of-service" class="tos-popup-wrapper popup-wrapper mfp-hide">
			...
			<p>These terms of service ("Terms", "Agreement") are an agreement between the operator of Insfollow ("Website operator", "us", "we" or "our") and you ("User", "you" or "your"). This Agreement sets forth the general terms and conditions of your use of the Insfollow website and any of its products or services (collectively, "Website" or "Services").</p>
			...
			<p><strong>This document was last updated on January 1, 2020</strong></p>
		</div>
		<div id="privacy-policy" class="pp-popup-wrapper popup-wrapper mfp-hide">
			<h1>Privacy policy</h1>
			<p>This privacy policy ("Policy") describes how we collect, protect and use the personally identifiable information ("Personal Information") you ("User", "you" or "your") provide on the Insfollow website and any of its products or services (collectively, "Website" or "Services"). It also describes the choices available to you regarding our use of your personal information and how you can access and update this information. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.</p>
